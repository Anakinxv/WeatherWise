...
function Settings() {
  return (
    <div className="flex flex-col h-full">
      {/* Encabezado */}
      <section className="w-full flex justify-between items-center flex-shrink-0">
      ...
      <section className="w-full flex items-center rounded-lg flex-1">
        <Tabs className="w-full h-full flex flex-col" defaultValue="general">
          <TabsList className="w-full h-12 text-[var(--sidebar-secondary)] border border-[var(--sidebar-border)] rounded-lg grid grid-cols-3 flex-shrink-0">
            <TabsTrigger
              value="general"
          ...
          <div className="mt-4 min-h-[60vh] flex-1 overflow-y-auto bg-[var(--sidebar-bg)] rounded-lg border border-[var(--sidebar-border)] p-4">
